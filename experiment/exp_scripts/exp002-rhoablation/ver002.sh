### ver002: effect of ρ for WHU Building dataset
...
model=efficientnet
bs_is_lr_epoch_comb=(
  "efficientnet 0.15 512 16 200 0.001 10 0.0 0.1 -5 -2 1 1 default True True"
  "efficientnet 0.15 512 16 200 0.001 10 0.1 0.1 -5 -2 1 1 default True True"
  "efficientnet 0.15 512 16 200 0.001 10 0.3 0.1 -5 -2 1 1 default True True"
  "efficientnet 0.15 512 16 200 0.001 10 0.5 0.1 -5 -2 1 1 default True True"
  "efficientnet 0.15 512 16 200 0.001 10 0.75 0.1 -5 -2 1 1 default True True"
  "efficientnet 0.15 512 16 200 0.001 10 0.99 0.1 -5 -2 1 1 default True True"
  )
