### ver003: WHU Building experiment for baseline (e.g. ce, tloss, emloss)
...
model=efficientnet
baseline_conb=(
  "ce 1.0 512 16 80 0.001 default True True"
  "emloss 1.0 512 16 80 0.001 default True True"
  "tloss 1.0 512 16 80 0.001 default True True"
)
